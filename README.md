...
- **Splitter**: controls how landscape pages are handled: split them into two pages, rotate the whole spread, or include both. Manga Style controls right-to-left page order.
